    ...
    return (
        <html lang="en">
           <head>
            ...
            <meta
                name="description"
                content="C.B football offers live betting on ongoing football matches from leagues around the world. Bet on your favorite teams and win big with our platform."
            />
            <meta
                name="keywords"
            ...
            />
            <meta name="author" content="C.B football " />

            <meta
                property="og:title"
                content="C.B football - Live Football Betting on Every League Worldwide"
            />
            <meta
                property="og:description"
                content="Join  C.B football for live betting on matches from leagues around the globe. Bet on your favorite teams in real-time and enjoy the excitement of winning."
            />
            <meta
                property="og:image"
            ...
            <body className="bg-blue-500">
                <section className="max-w-sm min-w-[384px] shadow-4 shadow-gray-700 justify-self-center relative">
                    <UserContextProvider>
